...
def score(board_list,drawn_number,score_board,score_board_num):
    score_sum = 0
    ...
    for drawn_number in drawn_numbers:
        ...
        for score_board_num,score_board in enumerate(score_boards):
            if confirm_win(score_board):
                print(score(board_list,drawn_number,score_board,score_board_num))
                break
        else:
            continue
